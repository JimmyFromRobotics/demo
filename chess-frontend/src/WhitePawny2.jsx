import whiteRook from './whitePawn4.png'
...
const WhitePawny2=(i, j)=>{
  console.log(i)
    const[a, b]=useState(0); 
const [{ isdragging }, drag, preview, clicked] = useDrag({
    canDrag: (Moves.canMov('WP')),
